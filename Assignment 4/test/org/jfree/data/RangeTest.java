...
class RangeTest {
	...
	void intersectOverlaps() {
		...
		assertAll(
			() -> assertTrue(range1.intersects(5, 8), "The return should be TRUE"),
			() -> assertTrue(range1.intersects(-15, -1), "The return should be TRUE")
				);
	}
	...
	void intersectDoNotOverlap() {
		...
		assertAll(
			() -> assertFalse(range1.intersects(11,15), "The return should be FALSE"),
			() -> assertFalse(range1.intersects(-15, -5), "The return should be FALSE")
				);
	}
